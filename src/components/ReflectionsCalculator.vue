      ...
      <form class="mt-5 sm:flex flex-col">
        <dl class="grid grid-cols-1 sm:grid-cols-2">
          <div class="w-full sm:max-w-xs mt-4">
            ...
            <input v-model="tokensUnformated" type="text" name="tokens" id="tokens" class="pl-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm bg-purple-200 border-gray-300 dark:text-gray-900 rounded-md p-1"/>
          </div>
          ...
          <div class="w-full sm:max-w-xs mt-4">
            ...
            <input v-model="volumeUnformated" type="text" name="volume" id="volume" class="pl-2 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 bg-purple-200 dark:text-gray-900 rounded-md p-1"/>
          </div>
        </dl>
